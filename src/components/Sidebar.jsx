  ...
  return (
    <div className={styles.sidebar}>
      <ul className={styles.sidebar_list}>
        ...
        <li
          className={styles.sidebar_row}
          id={window.location.pathname == "/education" ? "active" : ""}
          onClick={() => {
        ...
        <li
          className={styles.sidebar_row}
          id={window.location.pathname == "/teaching" ? "active" : ""}
          onClick={() => {
        ...
        <li
          className={styles.sidebar_row}
          id={window.location.pathname == "/examination" ? "active" : ""}
          onClick={() => {
            window.location.pathname = "/examination";
          }}
        >
          <div className={styles.sidebar_icon}>
            <BorderColorIcon />
        ...
        <li
          className={styles.sidebar_row}
          id={window.location.pathname == "/professional" ? "active" : ""}
          onClick={() => {
        ...
        <li
          className={styles.sidebar_row}
          id={window.location.pathname == "/research" ? "active" : ""}
          onClick={() => {
        ...
        >
          ...
          <div className={styles.sidebar_title}>Admin</div>
        </li>
      </ul>
    </div>
  );
